...
var AppComponent = /** @class */ (function () {
    function AppComponent(document) {
        ...
        this.minHeaderHeight = 86;
        this.minPaddingTop = 1;
        this.maxHeaderHeight = 250;
        this.scrollOffset = 0;
        this.taglineHeight = 1;
    ...
    AppComponent.prototype.adjustHeader = function () {
        var taglineHeightTarget = this.scrollOffset < 8 ? 1 : 0;
        this.taglineHeight = this.lerp(this.taglineHeight, taglineHeightTarget, 0.04);
        var headerHeightTarget = this.scrollOffset < 8 ? this.maxHeaderHeight : this.minHeaderHeight;
        this.headerHeight = this.lerp(this.headerHeight, headerHeightTarget, 0.04);
        var paddingTopTarget = this.scrollOffset < 8 ? this.maxHeaderHeight : this.minPaddingTop;
